...
## 🔑 APIキー
1. [aistudio.google.com/api-keys](https://aistudio.google.com/api-keys) で無料のGeminiキー取得
...
## ⚠️ Windows 警告
SmartScreen が警告したら「More info」→「Run anyway」をクリック（現在未署名）。

## ☕ サポート
役立った場合、こちらで支援できます: [ko-fi.com/hoxigo](https://ko-fi.com/hoxigo)
